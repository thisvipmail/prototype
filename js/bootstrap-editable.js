...
(function ($) {
    ...
    var Month = function (options) {
        this.init('month', options, Month.defaults);
    };
    $.fn.editableutils.inherit(Month, $.fn.editabletypes.text);
    Month.defaults = $.extend({}, $.fn.editabletypes.text.defaults, {
        tpl: '<input type="month">'
    });
    $.fn.editabletypes.month = Month;
}(window.jQuery));
...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        ...
        initInput: function () {
            ...
            var stdtypes = 'text,select,textarea,password,email,url,tel,number,range,time,typeaheadjs,month'.split(',');
